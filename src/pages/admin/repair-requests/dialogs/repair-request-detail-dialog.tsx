...
import { useGetRepairRequestDetailForAdmin } from "@/hooks/useRepairRequest";
...
export function RepairRequestDetailDialog({
  ...
  const { data: repairRequest, isLoading, isError } =
    useGetRepairRequestDetailForAdmin(repairRequestId ?? 0, open && !!repairRequestId);
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2 pl-6">
              {repairRequest.landlordFullName && (
                <div className="flex items-center gap-2">
                  <span className="text-sm font-medium">Họ tên:</span>
                  <span className="text-sm text-gray-600">
                    {repairRequest.landlordFullName}
            ...
            <div className="space-y-2 pl-6">
              {repairRequest.occurredAt && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">
                    {format(new Date(repairRequest.occurredAt), "dd/MM/yyyy HH:mm")}
                  </span>
                </div>
              )}
              {repairRequest.createdAt && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">
                    {format(new Date(repairRequest.createdAt), "dd/MM/yyyy HH:mm")}
                  </span>
                </div>
              )}
              {repairRequest.updatedAt && (
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-gray-600">
                    {format(new Date(repairRequest.updatedAt), "dd/MM/yyyy HH:mm")}
                  </span>
                </div>
              )}
            </div>
