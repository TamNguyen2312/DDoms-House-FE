...
import { useTenantUnitContracts } from "@/hooks/useUnit";
...
interface TenantContractSectionProps {
  unitId: number;
}

export function TenantContractSection({ unitId }: TenantContractSectionProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="SENT">Chờ ký</SelectItem>
