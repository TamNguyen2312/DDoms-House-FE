...
import type { IRentalRequest } from "@/pages/landlord/rental/types";
...
export function ViewRentalRequestDialog({
  ...
  const {
    ...
    isError: isErrorLandlord,
  } = useUserProfileById(
    rentalRequest.landlordId,
    open && !!rentalRequest.landlordId
  );
              ...
              <div className="space-y-2 pl-6">
                {isLoadingLandlord ? (
                  ...
                  <div className="text-sm text-muted-foreground">
                    Không thể tải thông tin người cho thuê
                  </div>
                ) : landlordProfile ? (
                  <>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-muted-foreground">
                        {landlordProfile.phone || "Chưa cập nhật"}
                      </span>
                    </div>
